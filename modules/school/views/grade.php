...
class View extends \Gcms\View
{
    ...
    {
        return '<tr><td colspan=2></td><td class=center>{LNG_Academic results}</td><td class=center>'.$this->credit.'</td><td class=center>'.Currency::format(Number::division($this->total, $this->credit), 2, ',', false).'</td></tr>';
    }
}
